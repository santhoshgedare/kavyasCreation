...
{
    /// <inheritdoc />
    public partial class RemoveVendorBuyerEntities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DropForeignKey(
                name: "FK_Orders_BuyerCompanies_BuyerCompanyId",
                table: "Orders");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VendorBuyerRelationships", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VendorBuyerRelationships_BuyerCompanies_BuyerCompanyId",
                        column: x => x.BuyerCompanyId,
                        principalTable: "BuyerCompanies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VendorBuyerRelationships_Vendors_VendorId",
                        column: x => x.VendorId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VendorBuyerRelationships_BuyerCompanyId",
                table: "VendorBuyerRelationships",
                column: "BuyerCompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_VendorBuyerRelationships_VendorId",
                table: "VendorBuyerRelationships",
                column: "VendorId");
